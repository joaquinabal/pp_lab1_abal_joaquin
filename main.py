...
5- Mostrar el promedio de puntos por partido de todo el equipo del Dream Team, ordenado por nombre de manera ascendente. 
    ...
    match(int(respuesta)):
        ...
        case 10:
            ...
            if valor_ingresado.replace(".", "").isnumeric():
                mostrar_jugadores_promediado_mas_stat(
                    lista_dreamteam, estadistica_a_buscar, float(valor_ingresado))
            else:
        ...
        case 12:
            ...
            if valor_ingresado.replace(".", "").isnumeric():
                ...
                print(
                    "Valor ingresado erróneo, por favor vuelva al menú e ingrese una opción nuevamente.")
        ...
        case 16:
            estadistica_a_buscar = "promedio_puntos_por_partido"
            promedio = generar_promedio_segun_stat_menos_peor_valor(
        ...
        case 20:
            lista_ordenada = ordenar_lista_segun_key(
                lista_dreamteam, "posicion")
            estadistica_a_buscar = "porcentaje_tiros_de_campo"
            valor_ingresado = input("Ingrese un valor para comparar: ")
            if valor_ingresado.replace(".", "").isnumeric():
                mostrar_jugadores_promediado_mas_stat(
                    lista_ordenada, estadistica_a_buscar, float(valor_ingresado), True)
            else:
                print("Valor ingresado erróneo, por favor vuelva al menú e ingrese una opción nuevamente.")

        case 23:
            exportar_ranking_csv(
                lista_dreamteam, 'pp_lab1_abal_joaquin/ranking_jugadores.csv')
